-- get_conversations() still had capitalized fallback strings ('Classmate',
-- 'Photo', 'File', 'This message was deleted') that leak straight into the
-- Chats-tab preview text — lowercase them to match the client's own copy.
