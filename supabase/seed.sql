...
from (values
  (1, 'kimk.demo@columbia.edu'),
  (2, 'liam.demo@columbia.edu'),
  (3, 'mbjordan.demo@columbia.edu'),
  (4, 'timmyc.demo@columbia.edu'),
  (5, 'presidentsnow.demo@columbia.edu'),
  (6, 'spiderman.demo@columbia.edu'),
  (7, 'spongebob.demo@columbia.edu'),
  (8, 'beyonce.demo@columbia.edu'),
  (9, 'therock.demo@columbia.edu'),
  (10, 'zendaya.demo@columbia.edu'),
  (11, 'batman.demo@columbia.edu'),
  (12, 'shrek.demo@columbia.edu'),
  (13, 'harrystyles.demo@columbia.edu'),
...
from (values
  ('d0000000-0000-0000-0000-000000000001'::uuid, 'Priya Chandrasekaran', 'Chemistry',
   'Edison, NJ', 'color-codes everything, including her feelings.',
  ...
  ('d0000000-0000-0000-0000-000000000008'::uuid, 'Wei Lin', 'Kinesiology',
   'San Francisco, CA', 'wakes up at 5am to train, lovingly judges everyone else''s sleep schedule.',
  ...
  ('d0000000-0000-0000-0000-000000000009'::uuid, 'Ada Nakamura', 'Computer Science',
   'Honolulu, HI', 'built an app to optimize her own procrastination.',
  ...
  ('d0000000-0000-0000-0000-000000000013'::uuid, 'Desmond Ortiz', 'Business',
   ...
   'CC', 2028),
  ('d0000000-0000-0000-0000-000000000014'::uuid, 'Vivian Cole', 'English',
   'Salem, MA', 'wears all black, reads everything, judges your font choices.',
   null, null, 'https://api.dicebear.com/9.x/adventurer/png?seed=vivian-cole&size=300', 'Butler stacks, lights off',
   'BC', 2027),
  ('d0000000-0000-0000-0000-000000000015'::uuid, 'Ethan Brooks', 'Political Science',
   'Fargo, ND', 'intense eye contact, surprisingly good study notes.',
   null, null, 'https://api.dicebear.com/9.x/adventurer/png?seed=ethan-brooks&size=300', 'Uris basement',
   'SEAS', 2029),
  ('d0000000-0000-0000-0000-000000000016'::uuid, 'Josephine Park', 'Chemistry',
   'Los Angeles, CA', 'loses her glasses at least once a week. still aces everything.',
   null, null, 'https://api.dicebear.com/9.x/adventurer/png?seed=josephine-park&size=300', 'Uris Library',
   'BC', 2028),
  ('d0000000-0000-0000-0000-000000000017'::uuid, 'Tommy Reeves', 'Nuclear Engineering',
   'Springfield, MO', 'forgets the reading, never forgets snack time.',
   null, null, 'https://api.dicebear.com/9.x/adventurer/png?seed=tommy-reeves&size=300', 'The cafeteria, obviously',
   'GS', 2030),
  ('d0000000-0000-0000-0000-000000000018'::uuid, 'Derek Sanders', 'Philosophy',
   'Boston, MA', 'deduces your major before you tell him.',
   null, null, 'https://api.dicebear.com/9.x/adventurer/png?seed=derek-sanders&size=300', 'Low Library, observing everyone',
   'CC', 2028),
  ('d0000000-0000-0000-0000-000000000019'::uuid, 'Freya Lindqvist', 'Pre-Law',
   'Minneapolis, MN', 'argues everything. wins most of it.',
   null, null, 'https://api.dicebear.com/9.x/adventurer/png?seed=freya-lindqvist&size=300', 'Law Library, front row',
   'BC', 2027),
  ('d0000000-0000-0000-0000-000000000020'::uuid, 'Claire Marsh', 'Philosophy',
   'Missoula, MT', 'speaks in riddles, always right anyway.',
   null, null, 'https://api.dicebear.com/9.x/adventurer/png?seed=claire-marsh&size=300', 'Low Library steps, meditating',
   'GS', 2030)
...
from (values
  ...
  ('d0000000-0000-0000-0000-000000000009'::uuid, 'COMS W3157', '001'),
  ('d0000000-0000-0000-0000-000000000009'::uuid, 'COMS W3134', '001'),
  ('d0000000-0000-0000-0000-000000000010'::uuid, 'COMS W3157', '001'),
  ('d0000000-0000-0000-0000-000000000010'::uuid, 'PSYC UN1001', '001'),
  ('d0000000-0000-0000-0000-000000000011'::uuid, 'COMS W3157', '001'),
  ('d0000000-0000-0000-0000-000000000011'::uuid, 'MATH UN1101', '001'),
  ('d0000000-0000-0000-0000-000000000012'::uuid, 'COMS W3157', '001'),
  ('d0000000-0000-0000-0000-000000000013'::uuid, 'MATH UN1101', '001'),
  ('d0000000-0000-0000-0000-000000000013'::uuid, 'ECON UN1105', '001'),
  ('d0000000-0000-0000-0000-000000000014'::uuid, 'COMS W3157', '001'),
  ('d0000000-0000-0000-0000-000000000014'::uuid, 'ENGL BC1068', '001'),
  ('d0000000-0000-0000-0000-000000000015'::uuid, 'COMS W3157', '001'),
